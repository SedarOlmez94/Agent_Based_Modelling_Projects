...
;delete from M all forces where not(minimise_impact) = 0 (no quantity of resource to be used i.e. A or B in this case) LINE 2 from algorithm.txt
  ...
  [
    ...
    set X fput first (min-max M_3 M_resources list_of_units_potentially_used min_resource_time_1 target_resource_remove) X ;LINES 4, 5, 6 from algorithm.txt
