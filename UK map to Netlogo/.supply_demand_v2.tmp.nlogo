...
to-report assign-resources [force-name-argument]
  ...
  ask forces with [force-name = force-name-argument][
    if force-name-argument = "St Albans"[
      set temp-list lput 1953
      set temp-list lput resource-total * resourceA-percentage
      set temp-list lput resource-total * resourceB-percentage
      set temp-list lput floor (resourceA-total * resourceA-percentage-public-order)
      set temp-list lput floor (resourceB-total * resourceB-percentage-public-order)
      set temp-list lput (resourceA-public-order-total + resourceB-public-order-total)
